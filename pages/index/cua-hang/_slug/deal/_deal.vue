<template>
    <div class="container-fluid">
        <div v-if="!mainData.isError">
            <div class="row">
                <div class="">
                    ...
                    <div class="">
                        <div class="box" style="padding:30px; border-top:0px; border-radius:0;">
                            <span style="font-family: 'Open Sans'; font-size:13px;">Giới hạn số lượng!</span><br>
                            <span>
              <span style="color:#ff5722;     flex-flow: row nowrap;  align-items: baseline; font-size: 32px; font-size: 2rem;font-weight: 700; font-family: 'Open Sans'">{{finalPrice | VN}}</span>&nbsp; <strike>
                <span style="font-family: 'Open Sans'; font-style: ">{{mainData.price | VN}}</span>
              </strike>
            </span>
        ...
        <el-dialog :visible.sync="v.dialogImageViewer" custom-class="noBorder" top="10px">
            <div slot="title">
                <img :src="v.imageSource" style="width:100%;">
            </div>
        </el-dialog>
        <el-dialog :visible.sync="v.dialogShowCounpon" custom-class="noBorder" top="calc(50vh - 200px)">
            <div slot="title">
                ...
                <div style="padding:10px;">
                    <p style="width:100%; text-align: center; font-size:24px;" v-if="!v.OverCode">
                        SỬ DỤNG MÃ COUPON BÊN DƯỚI
                    </p>
                        ...
                        <div style="margin-top:10px; margin-bottom:20px; border:1px dashed rgba(45,45,48,.4); padding:10px;">
                            <table class="table" style="margin:0; padding:0; ">
                                ...
                                <tr style="border:0;">
                                    ...
                                    <td v-if="!v.OverCode" style="border:0; width:50px; ">
                      <span class="material-icons mxCopy" style="padding-top:10px;"
        ...
        message:'Đã xảy ra sự cố, không thể sao chép!'
                        ...
                        <template>
                            <span style="font-size:18px; font-weight: bold; font-family: 'Open Sans'">{{mainData.title}}</span>
                            <br>
                            <span style="font-size:16px; color:rgba(45,45,48,.6);">{{mainData.description}}</span>
                            <br>
                            <br>
                            <span style="color:red; font-family: 'Open Sans'; margin-top:20px;">
                <br/>
                                <span class="fa fa-clock-o"></span> Còn
                                <time-count-down :to="mainData.to" style="  font-size:18px;"></time-count-down>
              </span>
                        </template>
                    </div>
                </div>
        ...
        <el-tooltip content="Thêm vào giỏ" placement="top">
            <button @click="m_AddToCard" class="addCartPro">
...
<script>
    ...
    export default {
        ...
        async asyncData({app, query, params, route, req, store, redirect}) {
            let mainData = {};
