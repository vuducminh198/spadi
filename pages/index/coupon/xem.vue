            ...
            <el-dialog :visible.sync="v.dialogShowCounpon" custom-class="noBorder" top="calc(50vh - 200px)">
                <div slot="title">
                    ...
                    <div style="padding:10px;">
                        <p style="width:100%; text-align: center; font-size:24px;" v-if="!v.OverCode">SỬ DỤNG MÃ COUPON
                            BÊN
                            DƯỚI</p>
                        <p style="width:100%; text-align: center; font-size:24px;" v-if="v.OverCode">Opps! HẾT MẤT
                            RỒI</p>
                        <br>
                        <div style="padding:10px;">
