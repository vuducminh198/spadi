                ...
                <div>
                    ...
                    <el-row :gutter="20" style="max-width:600px;margin-top:10px; margin-bottom:10px;">
                        <el-col :md="12" :sm="12" :xs="24" :lg="12">
                            ...
                            <el-input-number controls-position="right" v-model="form.addDeal.quantity"
                        ...
                        <el-col :md="12" :sm="12" :xs="24" :lg="12">
                            ...
                            <el-input-number controls-position="right" style="width:100%;"
                                             v-model="form.addDeal.price"></el-input-number>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20" style="max-width:600px;margin-top:10px; margin-bottom:10px;">
                        ...
                        <el-col :md="12" :sm="12" :xs="24" :lg="12">
                            ...
                            <el-input-number controls-position="right" style="width:100%;"
                                             v-model="form.addDeal.value"></el-input-number>
                        </el-col>
                    </el-row>
                    ...
                    <div style="margin-top:20px;">
                        <grebtn style="max-width:200px;" title="Tạo Deal" :loading="v.isLoading"
                                :type="'submit'"></grebtn>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            m_getDealDetailByInfo() {
                this.$http.get(process.env.API.Deal_GetDetailByID + this.$route.query._, this.cf())
                    .then(data => {
                        let res = data.body;
                        let shop = res.shop;
                        delete res.shop;
                        this.form.addDeal = res;
                        this.form.addDeal.shop = [];
                        shop.forEach(e => {
            ...
            m_formAddDealSubmit(e) {
                ...
                postForm.append('_id',this.form.addDeal._id);
                ...
                this.$confirm(`Bạn có chắc muốn thêm Deal: ${this.form.addDeal.title} không?`, 'Chú ý', {
                    ...
                    .then(() => {
                        ...
                        this.$http.put(process.env.API.Deal_Update, postForm, this.cf())
                            .then(data => {
