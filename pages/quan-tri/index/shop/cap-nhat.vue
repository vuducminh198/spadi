...
<template>
    <div>
        <p style="font-size:18px; padding-right:20px;">CẬP NHẬT THÔNG TIN CHI NHÁNH</p>
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            ...
            this.m_getShopInfoById();
        },
        methods: {
            m_getShopInfoById() {
                this.$http.get(process.env.API.Shop_DetailById + this.$route.query._, this.cf())
                    .then(data => {
                        this.form.addShop = data.body;
